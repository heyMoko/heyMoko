...
### 📱 Focus On
- **User-Centric Architecture**: 유지보수하기 쉽고 테스트 가능한 Android 구조를 지향합니다.
- **Modern Android**: Jetpack Compose, Kotlin Flow, Hilt 기반으로 상태와 화면 흐름을 설계하는 데 익숙합니다.
- **Sustainable Improvement**: 레거시 구조를 개선하고, 더 안정적인 코드베이스로 다듬는 작업에 관심이 많습니다.
...
### 🔎 Current Focus
- Jetpack Compose 기반 Android 구조와 상태 관리 흐름을 다시 다듬고 있습니다.
- 실무 경험을 바탕으로 포트폴리오와 개인 프로젝트를 정리하고 있습니다.
...
---
<div align="center">
  <i>더 읽기 쉽고 안정적으로 유지되는 코드를 고민합니다.</i>
</div>
